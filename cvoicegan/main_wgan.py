...
def main(config):
    ...
    # Data loader.
    loader = data.DataLoader(EmbeddingsDataset(config.data_dir), batch_size=config.batch_size, num_workers=config.num_workers)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_iters_decay', type=int, default=1900000, help='number of iterations for decaying lr')
    ...
    # Directories.
    parser.add_argument('--log_dir', type=str, default='/vol/bitbucket/apg416/project/cvoicegan/experiments/logs')
    parser.add_argument('--model_save_dir', type=str, default='/vol/bitbucket/apg416/project/cvoicegan/experiments/models')
    parser.add_argument('--sample_dir', type=str, default='/vol/bitbucket/apg416/project/cvoicegan/experiments/samples')
    parser.add_argument('--result_dir', type=str, default='/vol/bitbucket/apg416/project/cvoicegan/experiments/results')
    ...
    parser.add_argument('--data_dir', type=str, default='/vol/bitbucket/apg416/embs_covo/')
