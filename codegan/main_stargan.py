...
def main(config):
    ...
    # Data loader.
    loader = get_loader(config.selected_emos, config.mode, config.batch_size, config.num_workers)
...
if __name__ == '__main__':
    ...
    # Directories.
    parser.add_argument('--log_dir', type=str, default='/vol/bitbucket/apg416/project/codegan/experiments/logs')
    parser.add_argument('--model_save_dir', type=str, default='/vol/bitbucket/apg416/project/codegan/experiments/models')
    parser.add_argument('--sample_dir', type=str, default='/vol/bitbucket/apg416/project/codegan/experiments/samples')
    parser.add_argument('--result_dir', type=str, default='/vol/bitbucket/apg416/project/codegan/experiments/results')
    ...
    parser.add_argument('--selected_emos', '--list', nargs='+', help='selected emotions from IEMOCAP dataset', default=['ang', 'hap', 'sad', 'neu'])
